...
//               Alert.alert('Success', 'Membre retiré');
//             } catch (error) {
//               Alert.alert('Error', 'Unable to remove the member');
//             }
//           },
//         },
//       ]
...
// CardDetailScreen.jsx - AJOUT DE L'ASSIGNATION
import React, { useState } from 'react';
import {
  View,
  ScrollView,
...
const CardDetailScreen = ({ route, navigation }) => {
  ...
  const handleSave = async () => {
    try {
      const updates = {};
      if (editedName !== card.name) updates.name = editedName;
      if (editedDesc !== card.desc) updates.desc = editedDesc;
      ...
      Alert.alert('Error', 'Unable to update the map');
    }
  };
  ...
  const handleRemoveMember = async (memberId) => {
    Alert.alert(
      'Remove member',
      'Are you sure you want to remove this member from the map??',
      [
        { text: 'Cancel', style: 'cancel' },
        {
          text: 'Remove',
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <Text style={styles.sectionTitle}>Member assign</Text>
            <TouchableOpacity
        ...
        {/* ... autres sections (labels, date d'échéance) */}
