...
const WorkspaceFormModal = ({
  ...
  onCreate,
  onUpdate,
  workspace = null, // Si fourni, mode édition
}) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (isEditMode) {
        ...
        await onCreate(displayName, description);
      }
      ...
      alert(`Erreur lors de ${isEditMode ? 'la modification' : 'la création'} du workspace`);
    } finally {
      setLoading(false);
    }
  };
